...
public class PlayerScript : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        if (photonView.IsMine)
        {
            ...
            if (manager.GetComponent<RoomGameManager>().changingMap == true && PhotonNetwork.IsMasterClient == false)// 
            {
            ...
            if (manager.GetComponent<RoomGameManager>().changingMap == false && PhotonNetwork.IsMasterClient == false) //
            {
